...
public partial class PhysGunComponent : BaseWeapon
{
	...
	*/
	...
	protected override void OnUpdate()
	{
		...
		if(!Owner.IsValid())
			return;
		Owner.BodyController.LockCamera = rotating;
	...
	public override void OnControl()
	{
		...
		var eyeRot = Rotation.From( new Angles( 0.0f, Owner.BodyController.EyeAngles.yaw, 0.0f ) );
	...
	private void TryStartGrab( Vector3 eyePos, Rotation eyeRot, Vector3 eyeDir )
	{
		...
		//
		if ( body.BodyType == PhysicsBodyType.Keyframed && tr.Component is not BodyController )
			return;
	...
	private void GrabMove( Vector3 startPos, Vector3 dir, Rotation rot, bool snapAngles )
	{
		...
		if ( GrabbedObject.Root.Components.TryGet<BodyController>( out var player ) )
		{
