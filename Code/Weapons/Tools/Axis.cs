...
public sealed class Axis : ToolComponent
{
	...
	protected override void PrimaryAction()
	{
		...
		if ( hit.Hit && hit.GameObject?.Name != "Map" )
		{
			...
			else
			{
				...
				CreateAxis( PlayerState.Local.Pawn.GameObject, object1, hit.GameObject, hit.EndPosition, hit.Normal);
	...
	[Broadcast]
	public static void CreateAxis( GameObject player, GameObject object1, GameObject object2, Vector3 point2Pos, Vector3 axis)
	{
		AxisContext axisContext1 = object1?.Components.Create<AxisContext>();
        axisContext1.MainAxis = true;

        axisContext1.point = point2Pos;
